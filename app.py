...
st.header("How many collisions happened in an hour?")
hour = st.slider("Hour to look at" ,0,23)
data = data[data['date/time'].dt.hour == hour]
original_data = data
st.markdown("VEHICLE COLISSION BETWEEN %i:00 AND %i:00" %(hour , (hour + 1) %24 ))
...
st.subheader("Breaskdown by minute between %i:00 AND %i:00" %(hour , (hour + 1) %24 ))
filtered = data[
